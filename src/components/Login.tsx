    ...
    return (
        <section className={login.page}>
            ...
            <div className={login.fields}>
                ...
                <div className={error? login.email+' '+login.inputError:login.email}>
                    ...
                    <input  type="email" className={login.userInput} placeholder="username" onChange={handleEmailChange} value={email}/>
                </div>

                <div className={error? login.password+' '+login.inputError: login.password}>
                    <svg fill='#999' className="svg-icon" viewBox="0 0 20 20">
                    ...
                    <input type="password" className={login.passInput} placeholder="password" onChange={handlePasswordChange} value={password}/>
                </div>

            </div>

            <button className={login.loginButton} onClick={handleSubmit}>Login</button>

            {newUser && <button className={login.signinButton} onClick={handleSignUp}>Sign Up</button>}

            {!newUser && <div className={login.link}>

                            <a  href="/crypto_website">Forgot password?</a> or <span onClick={handleSignUp_anchor}>Sign Up</span>
