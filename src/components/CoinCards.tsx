...
export default function CoinCards(
  { handleCloseCard,coins,selectedCoins,coinCount}:
  { handleCloseCard:any,coins:any,selectedCoins:string[],coinCount:number}) {
    ...
    return (
      <>
        <h3 className="Dashboard_subtitle">My Dashboard {coinCount===8 ? <FaCheckCircle style={{color:'rgb(81, 202, 70)'}}/> : ""}</h3>    
                        ...
                        <div key={each.name} className="solution_card">
                            <div className="hover_color_bubble"></div>
                                <div data-value={each.name}  onClick={handleCloseCard}>
                                   <CloseIcon style={{float:'right',color:'rgb(230, 230, 230)',cursor:'pointer'}}/>
                                </div>
